...
from models.LSTM_one_layer_model_bi_aug import LSTMOneLayerModel
...
def main():
    ...
    model = LSTMOneLayerModel(config)
    ...
    trainer.model.save("evaluation/final_models/aug_bi_one_melody_128.h5")
