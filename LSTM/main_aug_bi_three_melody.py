...
from models.LSTM_three_layer_model_bi_aug import LSTMThreeLayerModel
...
def main():
    ...
    model = LSTMThreeLayerModel(config)
    ...
    trainer.model.save("evaluation/final_models/aug_bi_three_melody_512.h5")
