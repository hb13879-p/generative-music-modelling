...
class WritableOutput(object):
    ...
    def __create_list(self):
        self.args = []
        self.args.extend((self.name, self.seq_length,self.learning_rate,self.hidden_units,self.epochs,self.batch_size,self.train_loss,self.train_acc,self.val_loss,self.val_acc,self.test_loss,self.test_acc))
