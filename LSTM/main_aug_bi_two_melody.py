...
from models.LSTM_two_layer_model_bi_aug import LSTMTwoLayerModel
...
def main():
    ...
    model = LSTMTwoLayerModel(config)
    ...
    trainer.model.save("evaluation/final_models/aug_bi_two_melody_128.h5")
