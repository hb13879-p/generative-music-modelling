...
def main():
    ...
    print(readable_output.midi_paths[0])
    voicings = zip(readable_output.midi_paths[0],readable_output.midi_paths[1],readable_output.midi_paths[2],readable_output.midi_paths[3],readable_output.midi_paths[4])
    voicing_list = []
