...
class HmmMelodyDataLoader(BaseDataLoader):
    ...
    def __load_data(self):
        self.melody = pickle.load(
            open(
                os.path.abspath(
                    r"C:\Users\User\Documents\Project\Dataset\Augmented_outputs/melody_aug_cons_transp_"
                    + str(self.config.data.seq_length)
                    + "_"
                    + str(self.config.data.n_samples)
                    + ".p"
                ),
                "rb",
            )
        ...
        self.chord_rhythm = list(
            map(
                ...
                pickle.load(
                    open(
                        os.path.abspath(
                            r"C:\Users\User\Documents\Project\Dataset\Augmented_outputs/chord_rhythm_aug_cons_transp_with_melody_"
                            + str(self.config.data.seq_length)
                            + "_"
                            + str(self.config.data.n_samples)
                            + ".p"
        ...
        self.voicings = pickle.load(
            open(
                os.path.abspath(
                    r"C:\Users\User\Documents\Project\Dataset\Augmented_outputs/voicings_aug_cons_transp_with_melody_"
                    + str(self.config.data.seq_length)
                    + "_"
                    + str(self.config.data.n_samples)
                    + ".p"
        ...
        self.roots = pickle.load(
            open(
                os.path.abspath(
                    r"C:\Users\User\Documents\Project\Dataset\Augmented_outputs/roots_aug_cons_transp_with_melody_"
                    + str(self.config.data.seq_length)
                    + "_"
                    + str(self.config.data.n_samples)
                    + ".p"
        ...
        self.qualities = pickle.load(
            open(
                os.path.abspath(
                    r"C:\Users\User\Documents\Project\Dataset\Augmented_outputs/qualities_aug_cons_transp_with_melody_"
                    + str(self.config.data.seq_length)
                    + "_"
                    + str(self.config.data.n_samples)
                    + ".p"
    ...
    def save_data(self):
        pickle.dump(
            ...
            open(
                os.path.abspath(
                    r"C:\Users\User\Documents\Project\Models/Probabilistic/data_loaders/stored_data/aug_obs_seq.p"
                ),
                "wb",
            ),
        )
        pickle.dump(
            ...
            open(
                os.path.abspath(
                    r"C:\Users\User\Documents\Project\Models/Probabilistic/data_loaders/stored_data/aug_state_seq.p"
                ),
                "wb",
            ),
        )
        pickle.dump(
            ...
            open(
                os.path.abspath(
                    r"C:\Users\User\Documents\Project\Models/Probabilistic/data_loaders/stored_data/aug_label_encoders.p"
                ),
                "wb",
            ),
        )
