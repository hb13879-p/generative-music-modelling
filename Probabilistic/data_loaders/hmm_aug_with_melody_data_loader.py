...
class HmmMelodyDataLoader(BaseDataLoader):
    ...
    def __load_data(self):
        self.melody = pickle.load( open(os.path.abspath(r"C:\Users\User\Documents\Project\Dataset\Augmented_outputs/melody_aug_cons_transp_" + str(self.config.data.seq_length) + "_" + str(self.config.data.n_samples) + ".p"), "rb" ) )
        self.chord_rhythm = list(map(int,pickle.load( open(os.path.abspath(r"C:\Users\User\Documents\Project\Dataset\Augmented_outputs/chord_rhythm_aug_cons_transp_with_melody_" + str(self.config.data.seq_length) + "_" + str(self.config.data.n_samples) + ".p"), "rb" ) )))
        self.voicings = pickle.load(open(os.path.abspath(r"C:\Users\User\Documents\Project\Dataset\Augmented_outputs/voicings_aug_cons_transp_with_melody_" + str(self.config.data.seq_length) + "_" + str(self.config.data.n_samples) + ".p"), "rb" ) )
        self.roots = pickle.load(open(os.path.abspath(r"C:\Users\User\Documents\Project\Dataset\Augmented_outputs/roots_aug_cons_transp_with_melody_" + str(self.config.data.seq_length) + "_" + str(self.config.data.n_samples) + ".p"), "rb" ) )
        self.qualities = pickle.load(open(os.path.abspath(r"C:\Users\User\Documents\Project\Dataset\Augmented_outputs/qualities_aug_cons_transp_with_melody_" + str(self.config.data.seq_length) + "_" + str(self.config.data.n_samples) + ".p"), "rb" ) )

    def save_data(self):
        pickle.dump(self.get_obs_seq(),open( os.path.abspath(r"C:\Users\User\Documents\Project\Models/Probabilistic/data_loaders/stored_data/aug_obs_seq.p"), "wb" ))
        pickle.dump(self.get_state_seq(),open(os.path.abspath(r"C:\Users\User\Documents\Project\Models/Probabilistic/data_loaders/stored_data/aug_state_seq.p"), "wb" ))
        pickle.dump(self.get_label_encoders(),open( os.path.abspath(r"C:\Users\User\Documents\Project\Models/Probabilistic/data_loaders/stored_data/aug_label_encoders.p"), "wb" ))
    ...
    def encode_qualities(self):
        ...
        'dominant-13thflat9' : 1, "dominantsus4" : 1, 'dominantflat5' : 1,'half-diminished' : 2,'halfdim':2, 'major' : 3,\
        ...
        'minor-sixth' : 5, "minor-sixth9" : 5, 'major-minor' : 5, 'majmin':5, 'augmented-seventh' : 6, 'augmented' : 6, 'dominantsharp5' : 6, "dominantsharp11" : 7,
        "dominant-13thsharp11" : 7, "dominant-ninthsharp11" : 7,"domshp11" : 7}
