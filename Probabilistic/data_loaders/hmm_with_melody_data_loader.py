...
class HmmMelodyDataLoader(BaseDataLoader):
    ...
    def __load_data(self):
        self.melody = pickle.load( open(os.path.abspath(r"C:\Users\User\Documents\Project\Dataset/melody.p"), "rb" ) )
        self.chord_rhythm = list(map(int,pickle.load( open(os.path.abspath(r"C:\Users\User\Documents\Project\Dataset/chord_rhythm.p"), "rb" ) )))
        self.voicings = pickle.load(open(os.path.abspath(r"C:\Users\User\Documents\Project\Dataset/voicings.p"), "rb" ))
        self.roots = pickle.load(open(os.path.abspath(r"C:\Users\User\Documents\Project\Dataset/roots.p"), "rb" ))
        self.qualities = pickle.load(open(os.path.abspath(r"C:\Users\User\Documents\Project\Dataset/qualities.p"), "rb" ))
    ...
    def save_data(self):
        pickle.dump(self.get_obs_seq(),open( os.path.abspath(r"C:\Users\User\Documents\Project\Models/Probabilistic/data_loaders/stored_data/melody_obs_seq.p"), "wb" ))
        pickle.dump(self.get_state_seq(),open(os.path.abspath(r"C:\Users\User\Documents\Project\Models/Probabilistic/data_loaders/stored_data/melody_state_seq.p"), "wb" ))
        pickle.dump(self.get_label_encoders(),open( os.path.abspath(r"C:\Users\User\Documents\Project\Models/Probabilistic/data_loaders/stored_data/melody_label_encoders.p"), "wb" ))
