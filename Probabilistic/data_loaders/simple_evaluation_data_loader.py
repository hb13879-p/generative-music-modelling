...
class HmmMelodyDataLoader(BaseDataLoader):
    def __init__(self, config):
        ...
        self.obs_seq = pickle.load(open(os.path.abspath(r"C:\Users\User\Documents\Project\Models/Probabilistic/data_loaders/stored_data/simple_obs_seq.p"),"rb"))
        self.state_seq = pickle.load(open(os.path.abspath(r"C:\Users\User\Documents\Project\Models/Probabilistic/data_loaders/stored_data/simple_state_seq.p"),"rb"))
