...
class SimpleHmmDataLoader(BaseDataLoader):
    ...
    def save_data(self):
        pickle.dump(self.get_obs_seq(),open( os.path.abspath(r"C:\Users\User\Documents\Project\Models/Probabilistic/data_loaders/stored_data/simple_obs_seq.p"), "wb" ))
        pickle.dump(self.get_state_seq(),open(os.path.abspath(r"C:\Users\User\Documents\Project\Models/Probabilistic/data_loaders/stored_data/simple_state_seq.p"), "wb" ))
        pickle.dump(self.get_label_encoders(),open( os.path.abspath(r"C:\Users\User\Documents\Project\Models/Probabilistic/data_loaders/stored_data/simple_label_encoders.p"), "wb" ))
