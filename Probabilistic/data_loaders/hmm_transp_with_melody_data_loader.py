...
class HmmMelodyDataLoader(BaseDataLoader):
    ...
    def __load_data(self):
        self.melody = pickle.load(
            open(
                os.path.abspath(
                    r"C:\Users\User\Documents\Project\Dataset\Augmented_outputs/melody_transp_"
        ...
        self.chord_rhythm = list(
            map(
                ...
                pickle.load(
                    open(
                        os.path.abspath(
                            r"C:\Users\User\Documents\Project\Dataset\Augmented_outputs/chord_rhythm_transp_with_melody_"
                            + str(self.config.data.seq_length)
                            + ".p"
                        ),
                        "rb",
        ...
        self.voicings = pickle.load(
            open(
                os.path.abspath(
                    r"C:\Users\User\Documents\Project\Dataset\Augmented_outputs/voicings_transp_with_melody_"
                    + str(self.config.data.seq_length)
                    + "_1.p"
                ),
                "rb",
        ...
        self.roots = pickle.load(
            open(
                os.path.abspath(
                    r"C:\Users\User\Documents\Project\Dataset\Augmented_outputs/roots_transp_with_melody_"
                    + str(self.config.data.seq_length)
                    + ".p"
                ),
                "rb",
        ...
        self.qualities = pickle.load(
            open(
                os.path.abspath(
                    r"C:\Users\User\Documents\Project\Dataset\Augmented_outputs/qualities_transp_with_melody_"
                    + str(self.config.data.seq_length)
                    + ".p"
                ),
                "rb",
